            ...
            function ua(a, b, c) {
              ...
              l &&
                s(l, function(l) {
                  Oa.call(l.node, b)
                    ? g.push(l.callback)
                    : "leave" === c && Oa.call(l.node, a) && g.push(l.callback);
                });
              return g;
            }
            function h(a, b, c) {
        ...
        function() {
          return {
            cacheKey: function(b, d, f, k) {
              var e = b.parentNode;
              b = [
                e.$$ngAnimateParentKey || (e.$$ngAnimateParentKey = ++a),
                d,
            ...
            put: function(a, d, f) {
              b[a]
                ? (b[a].total++, (b[a].value = d))
                : (b[a] = { total: 1, value: d, isValid: f });
            }
          };
        }
      ];
              ...
              d.$$postDigest(function() {
                ...
                for (var d = x(g), t = 0; t < d.length; t++)
                  for (var f = d[t], e = 0; e < f.length; e++) {
                    ...
                    d[t][e] = h.fn;
                    0 === t
                      ? k.removeData("$$animatePrepareClasses")
        ...
        this.$get = [
          ...
          function(a, c, d, f, k, e, Q, L, x) {
            ...
            return function(a, b) {
                ...
                function b() {
                  if (!P) {
                    ...
                    p.applyAnimationDelay &&
                      ((ga =
                        "boolean" !== typeof g.delay && ya(g.delay)
                          ? parseFloat(g.delay)
                          : ga),
                      (W = Math.max(ga, 0)),
                      (r.animationDelay = ga),
                    ...
                    if (h.length) {
                      var n = h[0];
                      (F = e > n.expectedEndTime)
                        ? f.cancel(n.timer)
                        : h.push(v);
                    }
                    F &&
                      ((m = f(d, m, !1)),
                      (h[0] = { timer: m, expectedEndTime: e }),
                      h.push(v),
                      a.data("$$animateCss", h));
                ...
                if (!P)
                  if (l.parentNode) {
                    var e = function(a) {
                      ...
                      h =
                        0 < aa &&
                        ((r.transitionDuration && 0 === X.transitionDuration) ||
                          (r.animationDuration && 0 === X.animationDuration)) &&
              ...
              g.removeClass &&
                (S.length && (S += " "), (S += $(g.removeClass, "-remove")));
              ...
              p.applyTransitionDelay =
                ya(g.delay) && (p.applyTransitionDuration || p.hasTransitions);
              ...
              null == g.duration &&
                0 < r.transitionDuration &&
                (p.recalculateTimingStyles = p.recalculateTimingStyles || n);
              G = 1e3 * W;
              R = 1e3 * D;
              g.skipBlocking ||
              ...
              g.from &&
                (g.cleanupStyles && Ma(E, l, Object.keys(g.from)), Ia(a, g));
              p.blockTransition || p.blockKeyframeAnimation
                ? u(D)
                : g.skipBlocking || ra.blockTransitions(l, !1);
              return {
                $$willAnimate: !0,
                end: e,
                start: function() {
                  if (!P)
                    return (
                      (A = { end: e, cancel: L, resume: null, pause: null }),
                      (fa = new d(A)),
                      U(F),
                      fa
                    );
      ...
      function(a) {
        ...
        this.$get = [
          ...
          function(a, c, d, f, k, e, Q) {
            ...
            c = K(f);
            var u = A(
              (c.parentNode && 11 === c.parentNode.nodeType) || H.contains(c)
                ? c
                : H
            );
            return function(a) {
